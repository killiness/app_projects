...
Cloud.setup({
  ...
  methods: {
    ...
    "login": { "verb": "PUT", "url": "/api/v1/entrance/login", "args": ["fullName", "password", "rememberMe"] },
    "signup": { "verb": "POST", "url": "/api/v1/entrance/signup", "args": ["password", "fullName"] },
    ...
    "messageCreate": { "verb": "POST", "url": "/api/v1/sulla/message_create", "args": ["content", "totalSend", "isRandomSend", "userId"] },
